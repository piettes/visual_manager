class Color {
  ...
  static CHARTREUSE: Color = new Color("chartreuse", 0x88FF00, "#88FF00", 0x66DD00, 0x55BB00, 0x449900, 0x337700, 0x225500, 0x113300, 0x001100);
  static PURPLE: Color = new Color("purple", 0xFF00FF, "#FF00FF", 0xDD00DD, 0xBB00BB, 0x990099, 0x770077, 0x550055, 0x330033, 0x110011);
  static DEEP_PINK: Color = new Color("deep_pink", 0xFF0088, "#FF0088", 0xDD0066, 0xBB0055, 0x990044, 0x770033, 0x550022, 0x330011, 0x110000);
